...
# For running the streamlit use the below command in windows power-shell
# streamlit run "C:\Users\Abhijeet Sharma\Desktop\Plant Disease Detection\Plant Disease Detection System for Sustainable Agriculture\main.py"
# According to your path, you have to change it
...
# Import Image
img = Image.open(r"C:\\Users\\Abhijeet Sharma\\Desktop\\Plant Disease Detection\\Plant Disease Detection System for Sustainable Agriculture\\Diseases.png")
